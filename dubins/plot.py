...
from dubins.angle import rot_mat_2d 
...
def plot_arrow(x, y, yaw, arrow_length=3, # arrow_length=1.0 |  0.3 for reduced size
               origin_point_plot_style="xr",
               head_width=0.3, fc="r", ec="k", **kwargs):  # head_width=0.1 | 0.03 for reduced size
    """ 
